...
import { ItemFormArraySchema, ItemFormArrayType } from "@/types/item";
...
const SellerFormPage = () => {
    ...
    const {
        ...
        handleSubmit,
        formState: { errors },
    } = useForm<ItemFormArrayType>({
        resolver: zodResolver(ItemFormArraySchema),
        defaultValues: {
    ...
    const onSubmit = (data: ItemFormArrayType) => {
